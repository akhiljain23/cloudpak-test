...
def generate_records(start_date, end_date):
    ...
    print(dataframe)
    dataframe.to_csv("CloudPak-{}.csv".format(datetime.datetime.now().strftime("%Y-%m-%d-%H:%M:%S")), index=False)
